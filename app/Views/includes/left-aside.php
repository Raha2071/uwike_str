...
<div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="index.html"><img src="<?=appBaseURL?>/public/assets/images/icon/logo.png" alt="uwike logo"></a>
                </div>
            </div>
            <div class=" clearfix">
                ...
                <div class="menu-inner">
                    <nav>
                        ...
                        <li class="active active-list">
                                <a href="<?php linkto("dashboard"); ?>" aria-expanded="true"><i class="ti-dashboard"></i><span>Dashboard</span></a>
                                
                            </li>
                            <li class="">
                                <a href="javascript:void(0)" aria-expanded="true"><i class="ti-user"></i><span>Accounts</span></a>
                                <ul class="collapse">
                                    <li><a href="<?php linkto("accounts/admin/list") ;?>"> <i class="fa fa-long-arrow-right"></i>Administrators</a></li>
                                    <li><a href="<?php linkto("accounts/admin/list") ;?>"> <i class="fa fa-long-arrow-right"></i>clients</a></li>
