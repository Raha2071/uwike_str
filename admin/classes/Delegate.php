<?php
/**
 * Class for CRUD (Create Read Update Delete) or all users management
 */
...
class Delegate {
    ...
    private function connect(){
        $this->databaseHost = Config::get('mysql/host');
        $this->databaseUser = Config::get('mysql/username');
        $this->databasePass = Config::get('mysql/password');
        $this->databaseName = Config::get('mysql/db');
    ...
    public function rowCount($table, $rows = '*', $join = null, $where = null, $order = null, $limit = null){
        $selectQuery = 'SELECT '.$rows.' FROM '.$table;
        if($join != null){
            $selectQuery .= ' JOIN '.$join;
        }
