...
class User {
    ...
    public function find($user = null) {
        if($user) {
            $field ='email';
            $data = DB::getInstance()->query("SELECT * FROM future_participants WHERE email='$user'"); 
    ...
    {                       
        ...
        $mail->SetFrom('cubedigitalteamtest@gmail.com','Cube communications');
        $mail->AddReplyTo("cubedigitalteamtest@gmail.com","Cube communications");
